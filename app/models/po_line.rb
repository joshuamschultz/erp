class PoLine < ActiveRecord::Base
  ...
  def generate_pdf
    ...
    html = CommonActions.purchase_report(self.po_header.id)+'<style>#blank_page{display: none;} article.art-02 {margin: 20px 0 0;} @page{size:21cm 29.7cm;margin: 0mm 5mm 0mm 10mm;}</style>'
