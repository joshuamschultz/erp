class PoLine < ActiveRecord::Base
  ...
  def generate_pdf
    ...
    html = CommonActions.purchase_report(self.po_header.id)+'<style>#blank_page{display: none;} .art-01.art-04.art-07{  min-height: 448px;} .art-01.art-04{  min-height: 448px;} article.art-05{min-height: 100px;} article.art-01{min-height: 90px;} @page{size:21cm 29.7cm;margin: 12mm 5mm 2mm 10mm;}</style>'
