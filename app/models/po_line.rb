class PoLine < ActiveRecord::Base
 ...
 product1 = product2 = product_description =po_line_comment  = product_notes = source =''      
  self.po_header.po_lines.each do |po_line| 
    ...
    source+="<tr valign='top' align='left' class='h-pad'><td width='70'>" +po_line.po_line_quantity.to_s+"<td width='150'><table width='100%'' border='0'><tbody>"+product1+""+product2+"</tbody></table></td></td><td width='150'>"+product_description+"</td><td width='150'>"+(po_line.po_line_cost.to_f).to_s+"</td><td width='150'>"+(po_line.po_line_total.to_f).to_s+"</td></tr><tr class='h-pad'><td colspan='6' class='h-pad-04'>" +product_notes+"</td></tr><tr class='h-pad'><td colspan='6' class='h-pad-04'>" +po_line_comment+"</td></tr>"
  end 
