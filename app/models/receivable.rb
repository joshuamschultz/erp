class Receivable < ActiveRecord::Base  
  ...
  def generate_pdf
    ...
    product1 = product2 = product_description= source= ''
    ...
    self.so_shipments.includes(:so_line, :receivable_so_shipment).each do |so_shipment|
      qty = '<td>'+so_shipment.so_line.so_line_quantity.to_s+'</td>'
      shipped ='<td>'+ so_shipment.so_shipped_count.to_s+'</td>'
      ...
      product_cost = '<td>'+so_shipment.so_line.so_line_cost.to_s+'</td>'
      product_shipped_cost =  '<td>'+so_shipment.so_shipped_cost.to_s+'</td>'
      sub_total = so_shipment.so_shipped_cost.to_s

      source +='<tr class="h-pad" valign="top" align="left">
                  '+qty.to_s+'
                  '+shipped.to_s+'
                  <td>
