class Receivable < ActiveRecord::Base  
  ...
  def generate_pdf
    ...
    self.so_shipments.includes(:so_line, :receivable_so_shipment).each_with_index do |so_shipment, index| 
      ...
      if i== 1  
        content += ' <section><article><div class="ms_image"><div class="ms_image-wrapper"><img alt=Report_heading src=http://erp.chessgroupinc.com/'+@company_info.logo.joint.url(:original)+' /> </div><div class="ms_image-text"><h3> '+@company_info.company_address1+' <br> '+@company_info.company_address2+' </h3><h5><span> P:</span>  '+@company_info.company_phone1+' <br><span> F:&nbsp;</span> '+@company_info.company_fax+' </h5></div></div><div class="ms_image-2"><h2> Invoice</h2><div class="ms_image-5"><div class="ms_image-6"><h4> Date</h4><h5> '+self.created_at.strftime("%m/%d/%Y")+' </h5><div class="space"></div><h4> Chess S.O.#</h4> <h5> '+@so_header.so_identifier+' </h5> </div><div class="ms_image-6 ms_image-7"><h4> Inv No</h4><h5> '+self.receivable_identifier+' </h5><div class="space"></div><h4> Costomer P.O.#</h4> <h5> '+@so_header.so_header_customer_po+'  </h5>  </div><div class="clear"></div></div></div></article>'
        if flag ==1
           content += '<article class="art-01"><div class="ms_text-wra"><h2></h2><div class="ms_text"><h1 class="ms_heading">Bill To :</h1> <div class="ms_text-6"><h2 class="ms_sub-heading">'+in_contact_title+''+in_contact_address1+''+in_contact_address2+''+in_contact_state+''+in_contact_czip+'</h2></div></div></div><div class="ms_text-wra-02"><h2></h2><div class="ms_text-2"><h1 class="ms_heading">Ship To : </h1> <div class="ms_text-6"><h2 class="ms_sub-heading">'+ship_contact_title+''+ship_contact_address1+''+ship_contact_address2+''+ship_contact_state+''+ship_contact_czip+'</div></div></div></article>' 
          flag =0;
        end
