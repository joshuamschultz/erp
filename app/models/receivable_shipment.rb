class ReceivableShipment < ActiveRecord::Base
  ...
  :receivable_shipment_created_id, :receivable_shipment_identifier, :receivable_shipment_updated_id
  ...
  def check_total_shipped
  		total_shipped = self.so_line.receivable_shipments.sum(:receivable_shipment_count) + self.receivable_shipment_count
