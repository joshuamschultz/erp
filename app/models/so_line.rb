class SoLine < ActiveRecord::Base
  ...
  def generate_pdf
  p "tessssssssssssssssssssssssssssssssssssssssssssssssssst"
    ...
    so_line_quantity = so_line_shipped = ''
    ...
    if @so_header.ship_to_address.present?
      ...
      @so_header.so_lines.each do |so_line|
        ...
        so_line_quantity += '<strong>'+so_line.so_line_quantity.to_s+'</strong>'

        so_line_shipped += '<strong>'+so_line.so_line_shipped.to_s+'</strong>'

        if so_line.item_revision.present?
          item_description += '<strong>'+so_line.item_revision.item_description+'</strong>'
        end
