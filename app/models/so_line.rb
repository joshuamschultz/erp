class SoLine < ActiveRecord::Base
  ...
  def generate_pdf
    html = CommonActions.sales_report(self.so_header.id)+'<style>#blank_page{display: none;}.de{margin: 35px 0 0; min-height: 602px;}.sal_tab2 {height: 655px;} @page{size:21cm 29.7cm;margin: 10mm 5mm 2mm 10mm;}</style>'
