class CompanyInfosController < ApplicationController
  ...
  private
    ...
    def company_info_params
      ...
      :company_updated_id, :company_website, image_attributes: [:image_active, :image_content_type, :image_created_id, :image_description,
                                    :image_file_name, :image_file_size, :image_notes, :image_public, :image_title, :image_updated_id,
                                    :imageable_id, :imageable_type, :image], logo_attributes: [:joint_active, :joint_content_type, :joint_created_id, :joint_description,
