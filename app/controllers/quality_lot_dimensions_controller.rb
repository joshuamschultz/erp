    ...
    respond_to do |format|
      ...
      format.json { 
          @quality_lot_dimensions.each do |lot_dimension|
              ...
              lot_dimension[:item_part_pos_tolerance] = (lot_dimension.item_part_dimension.item_part_dimension + lot_dimension.item_part_dimension.item_part_pos_tolerance).round(4)
              lot_dimension[:item_part_neg_tolerance] = (lot_dimension.item_part_dimension.item_part_dimension - lot_dimension.item_part_dimension.item_part_neg_tolerance).round(4)
              ...
              lot_dimension[:lot_dimension_avg] = (lot_dimension.all_lot_dimensions.sum(:lot_dimension_value)/lot_dimension.all_lot_dimensions.count).round(4)
              ...
              lot_dimension[:lot_dimension_max] = lot_dimension.all_lot_dimensions.maximum(:lot_dimension_value).round(4)
              lot_dimension[:lot_dimension_min] = lot_dimension.all_lot_dimensions.minimum(:lot_dimension_value).round(4)
          end
