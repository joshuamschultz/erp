    ...
    respond_to do |format|
      ...
      format.json { 
          @quality_lot_dimensions.each do |lot_dimension|
              ...
              lot_dimension[:item_part_pos_tolerance] = (lot_dimension.item_part_dimension.item_part_dimension + lot_dimension.item_part_dimension.item_part_pos_tolerance).to_f.round(4)
              lot_dimension[:item_part_neg_tolerance] = (lot_dimension.item_part_dimension.item_part_dimension - lot_dimension.item_part_dimension.item_part_neg_tolerance).to_f.round(4)
              ...
              lot_dimension[:lot_dimension_avg] = (lot_dimension.all_lot_dimensions.sum(:lot_dimension_value)/lot_dimension.all_lot_dimensions.count).to_f.round(4)
              ...
              lot_dimension[:lot_dimension_std] = lot_dimension_values.stdev.round(4) rescue 0
              lot_dimension[:lot_dimension_max] = lot_dimension.all_lot_dimensions.maximum(:lot_dimension_value).to_f.round(4)
              lot_dimension[:lot_dimension_min] = lot_dimension.all_lot_dimensions.minimum(:lot_dimension_value).to_f.round(4)
          end
