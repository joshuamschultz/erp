        ...
        respond_to do |format|
            ...
            format.json { 
                @customer_quote_lines = @customer_quote_lines.select{|customer_quote_line|
                    ...
                    customer_quote_line[:quote_vendor_name] = customer_quote_line.quote.present? ? CommonActions.linkable(quote_path(customer_quote_line.quote), customer_quote_line.quote.quote_identifier) : ""
