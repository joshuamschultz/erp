  ...
  def create
    ...
    respond_to do |format|
      if @quality_lot_gauge_result.save
        ...
        # format.html { redirect_to(quality_lot_gauge_quality_lot_gauge_result_path(@quality_lot_gauge, :appraisor => params[:appraisor]), :notice => 'Quality lot gauge analysis was successfully updated.') }
