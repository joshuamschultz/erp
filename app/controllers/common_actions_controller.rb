              ...
              if params[:shipment_process_id].present?
                  ...
                  if so_shipment_process.count > 0
                    ...
                    if @so_header.po_header.present? && @so_header.po_header.po_type.type_value == "transer"
                      ...
                      so_b_c_address_1 = so['b_c_address_1']
                      so_b_c_address_2 = so['b_c_address_2']
                      so_b_c_state = so['b_c_state']
                      so_b_c_country = so['b_c_country']
                      so_b_c_zipcode = so['b_c_zipcode']
                      so_s_c_title = so['s_c_title']
                      so_s_c_address_1 = so['s_c_address_1']
                      so_s_c_address_2 = so['s_c_address_2']
                    ...
                    len = so_shipment_process.length
                    @company_info = CompanyInfo.first

                    so_shipment_process.each_with_index do |shipment, index|
            ...
            when "send_invoice"
              ...
              if @receivable.so_header.present?
                if @receivable.so_header.bill_to_address.present?
                  @customer_eamil = @receivable.so_header.bill_to_address.address_email
